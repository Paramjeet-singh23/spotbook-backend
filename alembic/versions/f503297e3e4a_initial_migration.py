...
Revision ID: f503297e3e4a
Revises:
Create Date: 2024-09-29 22:30:25.615976
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "event_type",
            sa.Enum("ONLINE", "OFFLINE", name="eventtypeenum"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("ADMIN", "USER", "MODERATOR", name="roleenum"),
            nullable=False,
        ),
